...
class MarcaControllerTest {
    ...
    void deveRetornarListaQuandoHouverResultados() {
        ...
        List<Marca> resultado = marcaController.listaMarcas();
    ...
    void deveRetornarMarcaPeloId() {
        ...
        ResponseEntity<Marca> resposta = marcaController.marcaPorId(1L);
    ...
    void deveResponderCreatedELocationQuandoCadastrarMarca() {
        ...
        ResponseEntity<Marca> resposta = marcaController.cadastraMarca(nova, uriBuilder);
    ...
    void deveAlterarNomeQuandoMarcaExistir() {
        ...
        ResponseEntity<Marca> resposta = marcaController.alteraNome(1L, new Marca(1L, "NOVA Audi"));
        assertEquals(HttpStatus.OK, resposta.getStatusCode());
    ...
    void deveDeletarMarcaExistente() {
        ...
        ResponseEntity<Marca> resposta = marcaController.deletaMarca(1L);
        assertEquals(HttpStatus.OK, resposta.getStatusCode());
